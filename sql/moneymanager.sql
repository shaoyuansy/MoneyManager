...
INSERT INTO `account` VALUES ('3', '债权账户', '-4000', '1', null);
INSERT INTO `account` VALUES ('4', '债务账户', '-500', '1', null);
INSERT INTO `account` VALUES ('5', '信用卡账户', '0', '1', null);
INSERT INTO `account` VALUES ('6', '银行卡账户', '109896', '1', null);
...
-- Records of budget
-- ----------------------------
INSERT INTO `budget` VALUES ('1', '2017-01-01', '1', '5000', '', '1');
INSERT INTO `budget` VALUES ('2', '2017-02-01', '2', '5000', '', '1');
INSERT INTO `budget` VALUES ('3', '2017-03-01', '3', '4500', '', '1');
INSERT INTO `budget` VALUES ('4', '2017-04-01', '4', '4500', '', '1');
INSERT INTO `budget` VALUES ('5', '2017-05-01', '5', '5000', '预计', '1');
...
-- Records of debtor
-- ----------------------------
INSERT INTO `debtor` VALUES ('1', '2017-05-04 12:00:00', '小郑', '本人', '4000', '小郑缺钱，急用', '1');
...
-- Records of income
-- ----------------------------
INSERT INTO `income` VALUES ('1', '2017-01-05 17:05:00', '职业收入', '银行卡账户', '6000', '本人', '', '1');
INSERT INTO `income` VALUES ('2', '2017-01-06 17:00:00', '职业收入', '银行卡账户', '9000', '丈夫', '', '1');
INSERT INTO `income` VALUES ('3', '2017-01-19 13:00:00', '兼职收入', '银行卡账户', '300', '本人', '稿子', '1');
INSERT INTO `income` VALUES ('4', '2017-02-05 13:00:00', '职业收入', '银行卡账户', '6800', '本人', '', '1');
INSERT INTO `income` VALUES ('5', '2017-02-06 13:00:00', '职业收入', '银行卡账户', '9800', '丈夫', '工资+奖金', '1');
INSERT INTO `income` VALUES ('6', '2017-02-22 13:00:00', '兼职收入', '银行卡账户', '320', '本人', '写稿', '1');
INSERT INTO `income` VALUES ('7', '2017-03-05 14:00:00', '职业收入', '银行卡账户', '6000', '本人', '本人工资', '1');
INSERT INTO `income` VALUES ('8', '2017-03-06 13:00:00', '职业收入', '银行卡账户', '9500', '丈夫', '工资+奖金', '1');
INSERT INTO `income` VALUES ('9', '2017-03-23 17:00:00', '兼职收入', '银行卡账户', '550', '本人', '写稿', '1');
INSERT INTO `income` VALUES ('10', '2017-04-05 14:30:00', '职业收入', '银行卡账户', '6000', '本人', '本人工资', '1');
INSERT INTO `income` VALUES ('11', '2017-04-06 13:00:00', '职业收入', '银行卡账户', '9300', '丈夫', '', '1');
INSERT INTO `income` VALUES ('12', '2017-04-16 12:00:00', '兼职收入', '现金账户', '500', '本人', '写稿所得', '1');
INSERT INTO `income` VALUES ('13', '2017-05-05 14:00:00', '职业收入', '银行卡账户', '6000', '本人', '', '1');
INSERT INTO `income` VALUES ('14', '2017-05-06 15:00:00', '职业收入', '银行卡账户', '9600', '丈夫', '', '1');
...
CREATE TABLE `outgo` (
  ...
  `uid` int(11) DEFAULT NULL,
  PRIMARY KEY (`oid`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf32;

-- ----------------------------
-- Records of outgo
-- ----------------------------
INSERT INTO `outgo` VALUES ('1', '2017-01-01 12:00:00', '食品酒水', '银行卡账户', '2000', '家庭公用', '吃饭开销', '1');
INSERT INTO `outgo` VALUES ('2', '2017-01-03 12:00:00', '交流通讯', '银行卡账户', '100', '丈夫', '', '1');
INSERT INTO `outgo` VALUES ('3', '2017-01-07 00:00:00', '人情往来', '银行卡账户', '600', '父母', '给爸妈买衣服和礼物', '1');
INSERT INTO `outgo` VALUES ('4', '2017-01-14 09:00:00', '食品酒水', '银行卡账户', '30', '家庭公用', '买菜', '1');
INSERT INTO `outgo` VALUES ('5', '2017-01-18 13:00:00', '居家物业', '银行卡账户', '1060', '家庭公用', '交房租', '1');
INSERT INTO `outgo` VALUES ('6', '2017-01-21 13:00:00', '衣服饰品', '银行卡账户', '200', '丈夫', '', '1');
INSERT INTO `outgo` VALUES ('7', '2017-01-21 14:00:00', '衣服饰品', '银行卡账户', '300', '丈夫', '买新衣服啦', '1');
INSERT INTO `outgo` VALUES ('8', '2017-01-22 17:00:00', '食品酒水', '银行卡账户', '500', '家庭公用', '日常吃喝', '1');
INSERT INTO `outgo` VALUES ('9', '2017-01-23 00:00:00', '食品酒水', '银行卡账户', '500', '家庭公用', '日常吃喝', '1');
INSERT INTO `outgo` VALUES ('10', '2017-01-27 17:00:00', '衣服饰品', '银行卡账户', '300', '本人', '买新衣服', '1');
INSERT INTO `outgo` VALUES ('11', '2017-01-29 12:00:00', '食品酒水', '银行卡账户', '128', '家庭公用', '吃肉蟹煲', '1');
INSERT INTO `outgo` VALUES ('12', '2017-01-31 14:00:00', '交流通讯', '银行卡账户', '50', '本人', '', '1');
INSERT INTO `outgo` VALUES ('13', '2017-02-01 00:00:00', '食品酒水', '银行卡账户', '2000', '家庭公用', '本月吃饭开销', '1');
INSERT INTO `outgo` VALUES ('14', '2017-02-04 15:00:00', '衣服饰品', '银行卡账户', '400', '本人', '买包包衣服化妆品', '1');
INSERT INTO `outgo` VALUES ('15', '2017-02-10 00:00:00', '交流通讯', '银行卡账户', '50', '本人', '', '1');
INSERT INTO `outgo` VALUES ('16', '2017-02-11 18:00:00', '衣服饰品', '银行卡账户', '200', '丈夫', '买包包腰带', '1');
INSERT INTO `outgo` VALUES ('17', '2017-02-18 13:00:00', '居家物业', '银行卡账户', '1060', '家庭公用', '交房租', '1');
INSERT INTO `outgo` VALUES ('18', '2017-02-18 15:00:00', '人情往来', '银行卡账户', '500', '父母', '给爸妈买生活用品', '1');
INSERT INTO `outgo` VALUES ('19', '2017-02-21 00:00:00', '交流通讯', '银行卡账户', '50', '丈夫', '', '1');
INSERT INTO `outgo` VALUES ('20', '2017-02-22 17:00:00', '食品酒水', '银行卡账户', '50', '家庭公用', '', '1');
INSERT INTO `outgo` VALUES ('21', '2017-02-26 15:00:00', '衣服饰品', '银行卡账户', '198', '本人', '买套装新衣服', '1');
INSERT INTO `outgo` VALUES ('22', '2017-02-26 16:00:00', '食品酒水', '银行卡账户', '60', '家庭公用', '', '1');
INSERT INTO `outgo` VALUES ('23', '2017-02-27 20:00:00', '人情往来', '银行卡账户', '235', '家庭公用', '请小葛小徐吃饭', '1');
INSERT INTO `outgo` VALUES ('24', '2017-03-01 00:00:00', '食品酒水', '银行卡账户', '2000', '家庭公用', '本月吃饭开销', '1');
INSERT INTO `outgo` VALUES ('25', '2017-03-03 16:00:00', '食品酒水', '银行卡账户', '300', '家庭公用', '本周买菜做饭', '1');
INSERT INTO `outgo` VALUES ('26', '2017-03-08 15:00:00', '人情往来', '银行卡账户', '1000', '父母', '妇女节给妈妈买礼物', '1');
INSERT INTO `outgo` VALUES ('27', '2017-03-11 13:00:00', '衣服饰品', '银行卡账户', '200', '本人', '买新外套啦', '1');
INSERT INTO `outgo` VALUES ('28', '2017-03-12 13:00:00', '食品酒水', '银行卡账户', '87', '家庭公用', '买良品铺子零食啦', '1');
INSERT INTO `outgo` VALUES ('29', '2017-03-15 13:00:00', '交流通讯', '银行卡账户', '50', '本人', '交话费', '1');
INSERT INTO `outgo` VALUES ('30', '2017-03-16 13:00:00', '交流通讯', '银行卡账户', '50', '丈夫', '交话费', '1');
INSERT INTO `outgo` VALUES ('31', '2017-03-18 13:00:00', '医疗保健', '银行卡账户', '300', '本人', '检查身体', '1');
INSERT INTO `outgo` VALUES ('32', '2017-03-18 21:00:00', '居家物业', '银行卡账户', '1060', '家庭公用', '房租', '1');
INSERT INTO `outgo` VALUES ('33', '2017-03-19 13:00:00', '数码产品', '银行卡账户', '5388', '丈夫', '买iPhone7', '1');
INSERT INTO `outgo` VALUES ('34', '2017-03-20 21:00:00', '休闲娱乐', '银行卡账户', '50', '家庭公用', 'ktv嗨皮', '1');
INSERT INTO `outgo` VALUES ('35', '2017-03-23 17:00:00', '学习进修', '银行卡账户', '68', '本人', '买书-PHP高级教程', '1');
INSERT INTO `outgo` VALUES ('36', '2017-04-01 00:00:00', '食品酒水', '银行卡账户', '2000', '家庭公用', '本月吃饭开销', '1');
INSERT INTO `outgo` VALUES ('37', '2017-04-07 12:00:00', '数码产品', '银行卡账户', '230', '丈夫', '耳机', '1');
INSERT INTO `outgo` VALUES ('38', '2017-04-10 12:00:00', '人情往来', '银行卡账户', '700', '父母', '给爸妈买衣服鞋子', '1');
INSERT INTO `outgo` VALUES ('39', '2017-04-14 12:00:00', '交流通讯', '银行卡账户', '50', '本人', '', '1');
INSERT INTO `outgo` VALUES ('40', '2017-04-15 08:00:00', '人情往来', '银行卡账户', '500', '家庭公用', '小吴结婚份子钱', '1');
INSERT INTO `outgo` VALUES ('41', '2017-04-18 17:00:00', '居家物业', '银行卡账户', '1060', '家庭公用', '房租', '1');
INSERT INTO `outgo` VALUES ('42', '2017-04-21 00:00:00', '数码产品', '银行卡账户', '150', '丈夫', '小米手环', '1');
INSERT INTO `outgo` VALUES ('43', '2017-04-22 12:00:00', '交流通讯', '银行卡账户', '50', '丈夫', '', '1');
INSERT INTO `outgo` VALUES ('44', '2017-04-29 16:00:00', '休闲娱乐', '银行卡账户', '200', '本人', '美容SPA卡', '1');
INSERT INTO `outgo` VALUES ('45', '2017-05-01 00:00:00', '食品酒水', '银行卡账户', '2000', '家庭公用', '本月吃饭开销', '1');
INSERT INTO `outgo` VALUES ('46', '2017-05-09 00:00:00', '交流通讯', '银行卡账户', '50', '本人', '', '1');
INSERT INTO `outgo` VALUES ('47', '2017-05-05 11:00:00', '学习进修', '银行卡账户', '300', '本人', '办季度瑜伽卡', '1');
INSERT INTO `outgo` VALUES ('48', '2017-05-13 15:00:00', '衣服饰品', '银行卡账户', '300', '本人', '夏季衣服鞋子', '1');
INSERT INTO `outgo` VALUES ('49', '2017-05-14 12:00:00', '衣服饰品', '银行卡账户', '400', '丈夫', '', '1');
INSERT INTO `outgo` VALUES ('50', '2017-05-15 12:00:00', '人情往来', '银行卡账户', '1000', '父母', '母亲节给妈妈买礼物', '1');
INSERT INTO `outgo` VALUES ('51', '2017-05-18 00:00:00', '居家物业', '银行卡账户', '1060', '家庭公用', '', '1');
INSERT INTO `outgo` VALUES ('52', '2017-05-20 09:00:00', '人情往来', '银行卡账户', '500', '家庭公用', '小张结婚份子钱', '1');
INSERT INTO `outgo` VALUES ('53', '2017-05-21 00:00:00', '交流通讯', '银行卡账户', '50', '丈夫', '', '1');
INSERT INTO `outgo` VALUES ('54', '2017-05-21 16:00:00', '人情往来', '银行卡账户', '170', '家庭公用', '请小李吃饭', '1');
...
-- Records of sign
-- ----------------------------
INSERT INTO `sign` VALUES ('1', '1', '67', '2017-05-24 10:51:03');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'Alice', '89f0b495890138511edbca8d446aa63e', '456321@126.com', '女', '15766666666', '/static/img/no-icon.jpg', 'Alice', '2017-05-24 10:50:56', '4', '2017-01-01 20:17:23', '', '你父亲的名字', '你就读过的学校', '你的生日', 'Jack', '郑州大学', '1994/12/04');
